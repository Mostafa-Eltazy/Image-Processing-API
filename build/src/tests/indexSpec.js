...
describe('Test endpoint response', () => {
    it('gets the the main route api endpoint', () => __awaiter(void 0, void 0, void 0, function* () {
        const response = yield request.get('/');
        expect(response.status).toBe(200);
    }));
    it('gets the /image api endpoint with no params', () => __awaiter(void 0, void 0, void 0, function* () {
